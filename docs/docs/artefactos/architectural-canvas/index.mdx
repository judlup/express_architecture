...
description: Copia del Architectural Canvas (se conservan imágenes).
---
...
![Architectural Canvas](/docs/artefacts/architectural-canvas/img/architectural_canvas_5.png)

![Architectural Canvas](/docs/artefacts/architectural-canvas/img/architectural_canvas_1.png)
